...
ThemeData lightTheme() {
  return ThemeData(
    ...
    textTheme: const TextTheme(
      displayLarge: TextStyle(fontSize: 32,color: darkColor,fontWeight: FontWeight.bold),
      ...
      bodyMedium:  TextStyle(fontSize: 14,color: darkColor,fontWeight: FontWeight.bold),
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ButtonStyle(
        ...
        shape: MaterialStatePropertyAll(BeveledRectangleBorder(borderRadius: BorderRadius.circular(20))),
...
ThemeData darkTheme() {
  return ThemeData(
    ...
    fontFamily: "Switzer",
    textTheme: const TextTheme(
      displayLarge: TextStyle(fontSize: 32,color: lightTextColor,fontWeight: FontWeight.bold),
      ...
      bodyMedium:  TextStyle(fontSize: 14,color: lightTextColor,fontWeight: FontWeight.bold),
